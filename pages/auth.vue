   ...
   <div id="AuthPage" class="w-full h-[100vh] bg-white">
      <div class="w-full flex items-center justify-center p-5 border-b border-b-gray-300">
         <NuxtLink to="/" class="min-w-[170px]">
            <img width="170" src="~/assets/AliExpress-logo.png"> 
         </NuxtLink>
      </div>
      ...
      <div class="max-w-[400px] mx-auto px-2">
         ...
         <button
            ...
            "
         >
            <img class="w-full max-w-[30px]" src="~/assets/google-logo.png">
            <div>Google</div>
         </button>
         ...
         <button 
            ...
            class="
               ...
               font-semibold"
            >
               <img class="w-full max-w-[30px]" src="~/assets/github-logo.png">
               <div>Github</div>
         </button>
      </div>
   </div>
